...
begin
  ...
  Memo1.Lines.Clear();
  Memo1.Lines.Add('Percent type ' + ProcentType);
  Memo1.Lines.Add('Amount of month ' + IntToStr(Months));
  Memo1.Lines.Add('Month percent ' + IntToStr(MounthProcent));
  Memo1.Lines.Add('Deposit ' + IntToStr(DefaultSum));
  Memo1.Lines.Add('Final summ ' + FloatToStr(addProcent));
end;
